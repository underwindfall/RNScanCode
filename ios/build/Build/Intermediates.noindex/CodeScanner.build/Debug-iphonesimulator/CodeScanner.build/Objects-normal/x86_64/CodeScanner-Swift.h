...
#import "/Users/ronael/Documents/ReactNative/CodeScanner/ios/CodeScanner-Bridging-Header.h"
...
SWIFT_MODULE_NAMESPACE_PUSH("CodeScanner")
...
SWIFT_CLASS("_TtC11CodeScanner8ScanView")
...
- (void)layoutSubviews;
@property (nonatomic, copy) RCTBubblingEventBlock _Nullable onScanCode;
...
SWIFT_CLASS_NAMED("RNScanView")
@interface RNScanView : ScanView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)reactSetFrame:(CGRect)frame;
- (void)setOnScanCodeWithHandler:(SWIFT_NOESCAPE void (^ _Nonnull)(NSDictionary * _Nullable))handler;
@end


SWIFT_CLASS_NAMED("RNScanViewManager")
@interface RNScanViewManager : RCTViewManager
