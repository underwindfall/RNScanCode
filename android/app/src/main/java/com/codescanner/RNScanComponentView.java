...
public class RNScanComponentView extends RNScanInstanceView {
    private MultiFormatReader mMultiFormatReader;
    public static final List<BarcodeFormat> ALL_FORMATS = new ArrayList();
    private List<BarcodeFormat> mFormats;
    private RNScanComponentView.ResultHandler mResultHandler;
    private ThemedReactContext mContext;

    public RNScanComponentView(ThemedReactContext context) {
        super(context);
        mContext = context;
    ...
    public void setResultHandler(RNScanComponentView.ResultHandler resultHandler) {
